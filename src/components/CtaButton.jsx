...
export default function CtaButton({ label, sublabel, className = "", url = influencerConfig.cta.url, brand = influencerConfig.brand }) {
  return (
    <motion.a
      ...
      className={`flex w-full max-w-[324px] flex-col items-center justify-center gap-[2px] rounded-[4px] px-[18px] py-[13px] text-center text-[#1a1a1a] shadow-[0_8px_20px_rgba(241,88,190,0.25)] cursor-pointer no-underline transition-opacity duration-150 hover:opacity-90 ${className}`}
